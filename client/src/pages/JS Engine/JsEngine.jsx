...
import CodeEditor from "../../components/JS Engine/CodeEditor"
import Visualizer from "../../components/JS Engine/Visualizer";
...
const JsEngine = () => {
  ...
  const runCode = async (codeInput) => {
    setCode(codeInput);
    try {
      const res = await fetch("http://127.0.0.1:3000/api/code/run", {
        method: "POST",
